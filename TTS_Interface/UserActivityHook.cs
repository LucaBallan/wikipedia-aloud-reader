...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        /// <summary>
        /// Handle definition for KeyPress
        /// </summary>
        public delegate void HookKeyEventHandler(KeyPressEventArgs info,KeyEventArgs extended_info);
        /// <summary>
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (KeyPress != null && wParam == WM_KEYDOWN)
                {
                              ...
                              MyKeyboardHookStruct.flags) == 1)
                    {
                        ...
                        KeyPressEventArgs info = new KeyPressEventArgs(key);

                        Keys keyData = (Keys)MyKeyboardHookStruct.vkCode;
                        KeyEventArgs extended_info = new KeyEventArgs(keyData);
                        KeyPress(info, extended_info);
                        handled = handled || info.Handled;
                    }
                    else
                    {
                        Keys keyData = (Keys)MyKeyboardHookStruct.vkCode;
                        KeyEventArgs extended_info = new KeyEventArgs(keyData);
                        KeyPress(null, extended_info);
                        handled = handled || extended_info.Handled;
                    }
                }
